# -*- coding: utf-8 -*-
# Generated by Django 1.9.4 on 2016-03-26 09:28
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('fee', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0.0'), default_currency='USD', max_digits=10)),
                ('fees_due', models.DateField()),
            ],
            options={
                'abstract': False,
            },
            bases=('core.event', models.Model),
        ),
        migrations.CreateModel(
            name='PaidItem',
            fields=[
